...
- ← Précédent : [Cours TypeScript 01 — C'est quoi TypeScript ?](./01_cest-quoi-typescript.md)
- → Suivant : [Cours TypeScript 03 — Les objets et le mot-clé `type`](./03_les-objets-et-type.md)
